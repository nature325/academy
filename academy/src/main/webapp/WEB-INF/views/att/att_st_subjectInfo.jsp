...
<table style="width:380px;">
	...
	<tr>
		<th>시작일</th>
		<td><input type="date" name="c_sdate" readonly value="${subdto.c_sdate }"></td>
	</tr>
	<tr>
		<th>종료일</th>
		<td><input type="date" name="c_edate" readonly value="${subdto.c_edate }"></td>
	</tr>
	<tr>
		<th>비고</th>
		<td colspan="3"><textarea rows="5" cols="20" name="c_memo" readonly value="${subdto.c_memo }"></textarea></td>
	</tr>
	<tr>
		<td colspan="4" style="text-align:center">			
			<button type="button" class="btn-gradient blue mini" onclick="self.close()">닫기</button>
		</td>
	</tr>
