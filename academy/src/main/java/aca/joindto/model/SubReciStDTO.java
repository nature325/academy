...
public class SubReciStDTO extends SubjectDTO {
	...
	public SubReciStDTO(int p_idx, String p_state, String p_payment, int p_pay, String p_paydate, int p_st_idx,
			int c_code, String p_bigo, int st_idx, String st_pwd, String st_name, String st_gen, String st_momtel,
			String st_fatel, String st_hometel, String st_addr, String st_school, String st_level, String st_memo,
			String st_status, Date st_date, String st_sms) {
		super();
		this.p_idx = p_idx;
